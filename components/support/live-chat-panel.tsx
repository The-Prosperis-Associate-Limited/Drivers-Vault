...
/*
  ...
  what the client sees. When a realtime channel exists this panel swaps its
  transport and keeps its shape.
*/
const QUICK_REPLIES: { label: string; category: TicketCategory }[] = [
  { label: "I can't find a suitable driver", category: "BOOKING" },
  { label: "A driver declined my request", category: "BOOKING" },
  { label: "A question about payment", category: "PAYMENT" },
